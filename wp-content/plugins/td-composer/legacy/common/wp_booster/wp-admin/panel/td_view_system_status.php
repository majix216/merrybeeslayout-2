    ...
    $td_banners_status = '
             <div class="td-admin-checkbox td-small-checkbox" style="border: none !important;">
                    <div class="td-demo-install-content">' .
                               td_panel_generator::checkbox(array(
                                   'ds' => 'td_option',
                                   'option_id' => 'td_banners_status',
                                   'true_value' => '',
                                   'false_value' => 'off',
                                   'class' => 'td-banners-status'
                               )) . '
                    </div>
            </div>';

    td_system_status::add('Theme config', array(
        'check_name' => 'tagDiv advertisement',
        'tooltip' => 'Show/Hide tagDiv advertisement',
        'value' =>  $td_banners_status,
        'status' => 'info',
    ));
    ...
    */
    ...
    <script>
        ...
        jQuery().ready(function() {
            ...
            // Hide tagDiv banners button
            jQuery('.td-checkbox.td-banners-status').on('click', function() {

                var element = document.querySelector("input[name='td_option[td_banners_status]']");
                    ...
                    mutations.forEach(function (mutation) {
                        if (mutation.type === "attributes") {
                            ...
                            jQuery.ajax({
                                ...
                                url: td_ajax_url,
                                data: {
                                    action: 'td_ajax_system_status_toggle_td_banners',
                                    td_banners_status: value,
                                    td_magic_token: tdWpAdminBannersSwitchNonce
                                },
                                success: function (data, textStatus, XMLHttpRequest) {
                                    console.log(data);
                                },
