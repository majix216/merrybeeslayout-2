                        ...
                        $buffy .= '<div class="tdb-filter-container tdb-filter-' . $filter_name . ' ' . $no_filters . '" >';
                            ...
                            switch ( $filter_type ) {
	                            ...
	                            case 'dropdown_search':
                                    ...
                                    // no option
                                    $default_option = ( ( $filter_type !== 'dropdown_search' && empty( $multiple ) ) || $is_tdc ) ? '<option value="" ' . $selected . ' disabled="disabled">-- ' . __td( 'Select', TD_THEME_NAME ) . ' ' . lcfirst( $filter_singular_name ) . ' --</option>' : '';
